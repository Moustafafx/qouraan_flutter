...
import 'package:qouraan_flutter/features/presentation/widgets/CompassCustom.dart';

class qebla extends StatefulWidget {
  const qebla({super.key});

  @override
  State<qebla> createState() => _qeblaState();
}

class _qeblaState extends State<qebla> {
